...
namespace VSX.SpaceCombatKit
{
	...
	public class ObstacleAvoidanceBehaviour : AISpaceshipBehaviour
	{
        ...
        void UpdateRiskFactor(ObstacleData obstacleData, bool show)
        {
            ...
            obstacleData.currentAvoidancePosition = obstacleData.raycastHit.point + obstacleData.raycastHit.normal * obstacleAvoidanceMargin;
            ...
            if (includeTimeToImpactFactor)
            {
                ...
                obstacleData.riskFactor *= obstacleData.timeToImpactFactor;
            }
