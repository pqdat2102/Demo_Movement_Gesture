...
namespace VSX.SpaceCombatKit
{
    ...
    ""controlSchemes"": [
        ...
        ~@SCKInputAsset()
        {
            UnityEngine.Debug.Assert(!m_SpacefighterControls.enabled, "This will cause a leak and performance issues, SCKInputAsset.SpacefighterControls.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_CapitalShipControls.enabled, "This will cause a leak and performance issues, SCKInputAsset.CapitalShipControls.Disable() has not been called.");
        }
