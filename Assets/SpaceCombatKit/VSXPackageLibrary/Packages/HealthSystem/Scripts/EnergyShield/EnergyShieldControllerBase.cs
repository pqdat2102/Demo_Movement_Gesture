...
namespace VSX.Health
{
    ...
    /// </summary>
    public class EnergyShieldControllerBase : MonoBehaviour
    {
        ...
        protected virtual void UpdateEffects()
        {
            ...
            for (int i = 0; i < effectInstances.Length; ++i)
            {
                ...
                tmp.x /= energyShieldMeshRenderer.transform.lossyScale.x;
                tmp.y /= energyShieldMeshRenderer.transform.lossyScale.y;
                tmp.z /= energyShieldMeshRenderer.transform.lossyScale.z;
