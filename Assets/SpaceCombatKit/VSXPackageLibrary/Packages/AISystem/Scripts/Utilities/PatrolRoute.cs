...
{
    /// <summary>
    /// This class represents a patrol route - a sequential series of waypoints that AI travels between.
    /// </summary>
    public class PatrolRoute : MonoBehaviour 
	{
        ...
        /// </summary>
		public virtual List<Transform> Waypoints { get => waypoints; }


        /// <summary>
        /// Get the length of the patrol route in scene units.
        /// </summary>
        /// <param name="looping">Whether the length should include a return to the first waypoint.</param>
