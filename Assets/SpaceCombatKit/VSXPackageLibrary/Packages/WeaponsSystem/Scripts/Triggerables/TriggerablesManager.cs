...
namespace VSX.Weapons
{
	...
	public class MountedTriggerable 
	{
		...
		public MountedTriggerable(Triggerable triggerable, Weapon weapon = null)
		{
	...
	public class TriggerablesManager : ModuleManager
	{
		...
		protected List<MountedTriggerable> mountedTriggerables = new List<MountedTriggerable>();
        public List<MountedTriggerable> MountedTriggerables { get { return mountedTriggerables; } }

        // A list of all the trigger indexes currently being triggered
        protected List<int> triggeredIndexes = new List<int>();
        ...
        protected virtual void CreateMountedTriggerable(Triggerable triggerable)
        {
            ...
            MountedTriggerable newMountedTriggerable = new MountedTriggerable(triggerable, triggerable.GetComponent<Weapon>());
