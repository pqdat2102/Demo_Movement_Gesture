...
namespace VSX.Loadouts
{
    public class SpawnSlotsUIController : MonoBehaviour
    {
        ...
        [SerializeField]
        protected UIFillBar spawnTimerFillBar;
        ...
        protected virtual void Update()
        {
            if (loadoutVehicleSpawner.Spawning)
            {
                ...
                spawnTimerFillBar.SetFill(Mathf.Clamp((Time.time - loadoutVehicleSpawner.SpawnWaitStartTime) / loadoutVehicleSpawner.SpawnWaitTime, 0, 1));
