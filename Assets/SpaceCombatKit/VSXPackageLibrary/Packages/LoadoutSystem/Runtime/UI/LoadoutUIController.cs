...
namespace VSX.Loadouts
{
    ...
    public class LoadoutUIController : MonoBehaviour
    {
        ...
        [Tooltip("The button to remove the currently equipped module.")]
        [SerializeField]
        protected GameObject removeModuleButton;
        ...
        public virtual void EnterModuleSelection()
        {
            ...
            loadoutManager.InitializeModuleSelection();
        ...
        protected virtual void OnLoadoutChanged()
        {
            ...
            {
                removeModuleButton.SetActive(!equipModuleButton.activeSelf);
            }
        ...
        public virtual void ClearSelectedModuleMount()
        {
            ...
            if (state == UIState.ModuleSelection)
            {
                loadoutManager.InitializeModuleSelection();
            }
        }
