...
namespace VSX.FloatingOriginSystem
{
    ...
    /// <summary>
    /// Add this to any object that needs to be moved when the floating origin shifts.
    /// </summary>
    public class FloatingOriginObject : MonoBehaviour
    {
        // Info for the trail renderers handled during origin shift.
        ...
        // Info for the particles handled during origin shift
        ...
        protected virtual void Awake()
        {
            ...
            trailRenderers = new List<TrailRenderer>(transform.GetComponentsInChildren<TrailRenderer>(true));
            ...
            particleSystems = new List<ParticleSystem>(transform.GetComponentsInChildren<ParticleSystem>(true));
            foreach (ParticleSystem particleSystem in particleSystems)
            {
                particlesArrays.Add(new ParticleSystem.Particle[particleSystem.main.maxParticles]);
            }

            FloatingOriginObject[] childObjects = transform.GetComponentsInChildren<FloatingOriginObject>(true);
        ...
        /// <summary>
        /// Set whether this floating origin object is activated.
        /// </summary>
        /// <param name="setActivated">Whether this floating origin object is activated.</param>
        ...
        /// <summary>
        /// Register with the floating origin manager.
        /// </summary>
        ...
        /// <summary>
        /// Deregister from the floating origin manager.
        /// </summary>
